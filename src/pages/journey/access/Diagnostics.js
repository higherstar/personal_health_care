...
function AccessDiagnostics(props) {
...
Roche makes these diagnostics available to more patients faster through its commercial
      ...
      <li>
        ...
        {' '}
        is imperative to ensure patients can be identified for appropriate treatment.
        This is especially important where alternatives do not exist and/or markers
        being tested for are very rare.
      </li>
      <li>
