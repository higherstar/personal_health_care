...
function MonitoringDiagnostics() {
  ...
  //                 particular
  //                 therapeutic product’s benefits to patients will outweigh
  // any potential serious side effects or risks.
  //         </li>
  //         <li>
  ...
  const content = (
    <div className="monitoring-diagnostics page-wrapper d-flex align-items-center justify-content-center">
