...
function DiagnosisDiagnostics(props) {
  ...
  const mainContent = (
    <>
      <h2>Description</h2>
      <p>
        Diagnostic tools are used to detect diseases or other conditions, and can be used
        to monitor a person’s overall health to help prevent, treat, and cure diseases. Moreover, they may support
...
DiagnosisDiagnostics.propTypes = {
