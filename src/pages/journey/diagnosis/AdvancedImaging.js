...
function DiagnosisAdvancedImaging(props) {
...
(Ophthalmology, Cancer Immunotherapy), and Multiple Sclerosis to develop automated algorithms
  ...
  const content = (
    <div className="journey-advanced-imaging page-wrapper d-flex align-items-center justify-content-center">
...
DiagnosisAdvancedImaging.propTypes = {
